...
# ==============================================================================
# Bug Detection Training - COMPLETE (Train + Val + Test)
# For: nahian26@narval  
...
# 4. Save test_results.json with final test metrics
# ==============================================================================

echo "=============================================="
echo "Bug Detection - COMPLETE (Train+Val+Test)"
echo "=============================================="
...
SCRIPT="$BASE_DIR/scripts/train_complete_with_test.py"
...
# Using gcc/12.3 - check available OpenCV with: module spider opencv
module load gcc/12.3.1 opencv/4.8.1
echo "  ✓ GCC 12.3 + OpenCV"
