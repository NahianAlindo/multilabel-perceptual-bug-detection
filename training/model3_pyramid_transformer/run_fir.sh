...
CHECKPOINT_DIR="/home/nahian26/scratch/checkpoints/model3_pyramid_transformer"
LOGDIR="/home/nahian26/scratch/runs/model3_pyramid_transformer"
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "🔍 Logs:"
    echo "   /home/nahian26/scratch/logs/model3_pyramid_${SLURM_JOB_ID}.out"
    echo "   /home/nahian26/scratch/logs/model3_pyramid_${SLURM_JOB_ID}.err"
fi
