...
#SBATCH --job-name=bugdet_gru
#SBATCH --output=/home/nahian26/projects/def-loutfouz/nahian26/bugdatasetbig/logs_gru/training_%j.out
#SBATCH --error=/home/nahian26/projects/def-loutfouz/nahian26/bugdatasetbig/logs_gru/training_%j.err
#SBATCH --mail-user=nahian.rifaat@ontariotechu.net
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

# ==============================================================================
# ResNet18+GRU MODEL - Bug Detection Training (Train + Val + Test)
# For: nahian26@rorqual.alliancecan.ca
...
echo "=============================================="
echo "ResNet18+GRU MODEL - Bug Detection Training"
echo "=============================================="
...
# ==============================================================================
# Paths (GRU-specific directories)
# ==============================================================================

BASE_DIR="/home/nahian26/projects/def-loutfouz/nahian26/bugdatasetbig"
DATA_ROOT="$BASE_DIR"
MANIFEST="$BASE_DIR/my_new_splits.jsonl"
SCRIPT="$BASE_DIR/scripts_gru/train_resnet18_gru_complete.py"
CHECKPOINT_DIR="/home/nahian26/scratch/checkpoints/resnet18_gru"
TENSORBOARD_DIR="/home/nahian26/scratch/runs/resnet18_gru"
LOGS_DIR="$BASE_DIR/logs_gru"
...
export WANDB_PROJECT="resnet18-gru-bug-detection"
...
if [ ! -f "$SCRIPT" ]; then
    ...
    echo "   Please upload train_resnet18_gru_complete.py to scripts_gru/ directory"
    exit 1
fi
...
echo ""
echo "🚀 Starting ResNet18+GRU training..."
echo "📊 Monitor at: https://wandb.ai (if enabled)"
echo "   TensorBoard: tensorboard --logdir=$TENSORBOARD_DIR"
echo ""
echo "Configuration:"
echo "  Model: ResNet18+GRU (alternative temporal architecture)"
...
echo "  Test F1:     ~86% (GRU temporal modeling)"
echo "  Comparison:  vs BiLSTM ~87%, vs I3D ~85%"
echo "  Purpose:     Show BiLSTM > GRU for temporal"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "   # Best model"
    echo "   scp nahian26@rorqual:$BEST_CKPT ./"
    echo ""
    echo "   # Test results"
    echo "   scp nahian26@rorqual:$TEST_RESULTS ./"
    echo ""
    echo "   # All visualizations"
    echo "   scp -r nahian26@rorqual:$VIZ_DIR ./"
    echo ""
    ...
    echo "🔄 To continue:"
    echo "   cd $BASE_DIR"
    echo "   sbatch run_resnet18_gru_training.sh"
    echo ""
