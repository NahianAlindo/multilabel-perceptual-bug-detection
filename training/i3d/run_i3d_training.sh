...
#SBATCH --job-name=bugdet_i3d
#SBATCH --output=/home/nahian26/projects/def-loutfouz/nahian26/bugdatasetbig/logs_i3d/training_%j.out
#SBATCH --error=/home/nahian26/projects/def-loutfouz/nahian26/bugdatasetbig/logs_i3d/training_%j.err
#SBATCH --mail-user=nahian.rifaat@ontariotechu.net
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

# ==============================================================================
# I3D MODEL - Bug Detection Training (Train + Val + Test)
# For: nahian26@fir.alliancecan.ca
...
echo "=============================================="
echo "I3D MODEL - Bug Detection Training"
echo "=============================================="
...
# ==============================================================================
# Paths (I3D-specific directories)
# ==============================================================================

BASE_DIR="/home/nahian26/projects/def-loutfouz/nahian26/bugdatasetbig"
DATA_ROOT="$BASE_DIR"
MANIFEST="$BASE_DIR/my_new_splits.jsonl"
SCRIPT="$BASE_DIR/scripts_i3d/train_i3d_complete.py"
CHECKPOINT_DIR="/home/nahian26/scratch/checkpoints/i3d_model"
TENSORBOARD_DIR="/home/nahian26/scratch/runs/i3d_model"
LOGS_DIR="$BASE_DIR/logs_i3d"
...
# Load GCC and OpenCV (try both versions)
...
export WANDB_PROJECT="i3d-bug-detection"
...
if [ ! -f "$SCRIPT" ]; then
    ...
    echo "   Please upload train_i3d_complete.py to scripts_i3d/ directory"
    exit 1
fi
...
echo "  Test F1:     ~85% (3D CNN baseline)"
echo "  Comparison:  vs ResNet18+BiLSTM ~87%"
echo "  Purpose:     Prove 2D+temporal > 3D"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "   # Best model"
    echo "   scp nahian26@fir:$BEST_CKPT ./"
    echo ""
    echo "   # Test results"
    echo "   scp nahian26@fir:$TEST_RESULTS ./"
    echo ""
    echo "   # All visualizations"
    echo "   scp -r nahian26@fir:$VIZ_DIR ./"
    echo ""
    ...
    echo "🔄 To continue:"
    echo "   cd $BASE_DIR"
    echo "   sbatch run_i3d_training.sh"
    echo ""
