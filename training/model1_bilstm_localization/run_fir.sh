...
# Runs: pilot → HPO → full training → test (one job)
# ==============================================================================
...
echo ""
echo "Configuration:"
echo "  Mode      : train (pilot=no, HPO trials=15, full training → test)"
echo "  Backbone  : ResNet18 (pretrained ImageNet)"
echo "  Temporal  : BiLSTM (hidden=256, layers=2, bidirectional)"
echo "  Head      : multi-label cls + temporal regression"
echo "  Loss      : ASL + DIoU + Focal"
